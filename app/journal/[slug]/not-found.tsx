...
export default function JournalArticleNotFound() {
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center px-6 text-center">
      <h1 className="font-display text-3xl font-bold text-foreground">Makale bulunamadı</h1>
      <p className="mt-4 text-foreground/50">Aradığınız journal yazısı mevcut değil.</p>
      <Link
        href={JOURNAL_BASE}
