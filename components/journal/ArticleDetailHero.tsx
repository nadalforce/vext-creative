...
export function ArticleDetailHero({ article }: ArticleDetailHeroProps) {
  return (
    <header className="relative">
      <div className="relative aspect-[21/9] min-h-[240px] overflow-hidden rounded-3xl border border-foreground/[0.08] ring-1 ring-foreground/10 md:min-h-[360px]">
        <Image
      ...
      <div className="relative -mt-16 px-2 md:-mt-20 md:px-6">
        ...
        <h1 className="font-display mt-6 max-w-4xl text-3xl font-extrabold leading-[1.08] tracking-[-0.02em] text-foreground md:text-5xl lg:text-6xl">
          {article.title}
        </h1>
        <div className="mt-8 flex flex-wrap items-center gap-6 text-sm text-foreground/45">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-medium text-foreground/80">{article.author}</p>
