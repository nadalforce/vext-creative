    ...
    >
      <div className="grid lg:grid-cols-2">
        <div className="relative min-h-[280px] lg:min-h-[420px]">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-r from-black/20 via-transparent to-black/60 lg:bg-gradient-to-r lg:from-transparent lg:to-black" />
        </div>
        <div className="relative flex flex-col justify-center p-8 md:p-12 lg:p-14">
          ...
          <h2
            ...
            className="font-display mt-4 text-3xl font-bold leading-tight text-white md:text-4xl lg:text-[2.75rem]"
          >
            {article.title}
          </h2>
